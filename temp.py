...
import os
st.title('Deepak\'s mashup:musical_note::musical_note::musical_note:')
# st.write('Made by Deepak Bansal')
...
# Email credentials
        from_email = "deepakbansal2609@gmail.com"
        to_email = Email
        password = "aplkmqkndmlnmcwg"
